...
spark = SparkSession.builder.appName("Delta-Lake-MS8").config("spark.jars.packages", \
...
spark.sparkContext.addPyFile("s3://keerthi-reddy-landing-batch6-tigeril"\
                             +"/dependencyfiles/"\
...
class Transformation:
    ...
    def read_config(self) -> json:
        ...
        app_config_path = "s3://keerthi-reddy-landing-batch6-tigeril/config-files/app-config.json"
